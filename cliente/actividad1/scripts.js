    ...
    */
    const cargarTabla = (misProductos) => {
        ...
        misProductos.forEach(product => {
            ...
            productoTd.classList.add( 'align-middle');
            ...
            masButton.classList.add('btn', 'btn-primary');
            ...
            menosButton.classList.add('btn', 'btn-primary');
            ...
            cantidadInput.value = unidades;
            cantidadInput.classList.add('form-control', 'text-center');
            cantidadInput.type = "number";
            cantidadInput.min = "0";
            cantidadInput.style.width = "100px";
            ...
            precioTd.classList.add( 'align-middle');
            ...
            totalTd.classList.add( 'align-middle');
    ...
    fetch("https://jsonblob.com/api/1422514322785099776")
